# -*- encoding: utf-8 -*-
# stub: jekyll-algolia 1.1.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<algolia_html_extractor>.freeze, ["~> 2.2"])
      s.add_runtime_dependency(%q<algoliasearch>.freeze, ["~> 1.18"])
      ...
      s.add_dependency(%q<algolia_html_extractor>.freeze, ["~> 2.2"])
      s.add_dependency(%q<algoliasearch>.freeze, ["~> 1.18"])
